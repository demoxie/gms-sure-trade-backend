...
export interface Options extends Logging {
  migrationSeedingTableName: string;
  migrationSeedingStoragePath: string;
  migrationSeedingStorage: string;
  migrationSeedingDir: string;
  migrationDir: string;
  migrationRun: string;
  migrationEnable: string;
  migrationStorageTableEngine: string;
